         ...
         do it = 1, NT
           ...
           do iz = 1, NZ
             ...
             do iy = 1, NY
                ...
                modx = IAND(MASK1,1+ibush+iy+iz+it)
*VOPTION INDEP(b)
*VOPTION PREFETCH(a)
                do ix = 1+modx, NX, 2  ! 13,2000 by A.N.
                  ix1 = ix + idel(1)
...
c
c       c%g( 1, 1, i) = (0.D0,0.D0) 
c       c%g( 1, 2, i) = (0.D0,0.D0) 
c       c%g( 1, 3, i) = (0.D0,0.D0) 
c       c%g( 2, 1, i) = (0.D0,0.D0) 
c       c%g( 2, 2, i) = (0.D0,0.D0) 
c       c%g( 2, 3, i) = (0.D0,0.D0) 
c       c%g( 3, 1, i) = (0.D0,0.D0) 
c       c%g( 3, 2, i) = (0.D0,0.D0) 
c       c%g( 3, 3, i) = (0.D0,0.D0) 
c
c     enddo
c     enddo
c
...
*VOPTION PREFETCH(a,b)
       do i = ista, iend
         ...
         c%g(1,1,i)=a%g(1,1,i)*conjg(b%g(1,1,i))
     &             +a%g(1,2,i)*conjg(b%g(1,2,i))
     &             +a%g(1,3,i)*conjg(b%g(1,3,i)) 
         c%g(1,2,i)=a%g(1,1,i)*conjg(b%g(2,1,i))
     &             +a%g(1,2,i)*conjg(b%g(2,2,i))
     &             +a%g(1,3,i)*conjg(b%g(2,3,i)) 
         c%g(1,3,i)=a%g(1,1,i)*conjg(b%g(3,1,i))
     &             +a%g(1,2,i)*conjg(b%g(3,2,i))
     &             +a%g(1,3,i)*conjg(b%g(3,3,i)) 
         c%g(2,1,i)=a%g(2,1,i)*conjg(b%g(1,1,i))
     &             +a%g(2,2,i)*conjg(b%g(1,2,i))
     &             +a%g(2,3,i)*conjg(b%g(1,3,i)) 
         c%g(2,2,i)=a%g(2,1,i)*conjg(b%g(2,1,i))
     &             +a%g(2,2,i)*conjg(b%g(2,2,i))
     &             +a%g(2,3,i)*conjg(b%g(2,3,i)) 
         c%g(2,3,i)=a%g(2,1,i)*conjg(b%g(3,1,i))
     &             +a%g(2,2,i)*conjg(b%g(3,2,i))
     &             +a%g(2,3,i)*conjg(b%g(3,3,i)) 
         c%g(3,1,i)=a%g(3,1,i)*conjg(b%g(1,1,i))
     &             +a%g(3,2,i)*conjg(b%g(1,2,i))
     &             +a%g(3,3,i)*conjg(b%g(1,3,i)) 
         c%g(3,2,i)=a%g(3,1,i)*conjg(b%g(2,1,i))
     &             +a%g(3,2,i)*conjg(b%g(2,2,i))
     &             +a%g(3,3,i)*conjg(b%g(2,3,i)) 
         c%g(3,3,i)=a%g(3,1,i)*conjg(b%g(3,1,i))
     &             +a%g(3,2,i)*conjg(b%g(3,2,i))
     &             +a%g(3,3,i)*conjg(b%g(3,3,i)) 
